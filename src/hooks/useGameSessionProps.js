...
export function useGameSessionProps({
  ...
  const globeProps = useMemo(
    () => ({
      ...
      globeTheme,
      learnSubMode:
        currentScreen === "home" ? (homeMode === "capitals" ? "capitals" : homeMode) : learnSubMode,
      globeFeedbackRef,
      globeFeedbackApplierRef,
    }),
    [
  ...
  return useMemo(
    ...
    [hudProps, globeProps, endScreenProps, panelProps, currentScreen, showEndScreen, isPanelOpen]
  );
}
