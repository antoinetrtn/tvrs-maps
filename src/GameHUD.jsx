...
import { Globe, MapPin, InfoBox, Square, Close, ChevronLeft, ChevronRight, Home, Play, Waves, TreePine } from 'pixelarticons/react';
...
const GameHUD = ({
  ...
  globeTheme,
  learnShowCountryLabels, setLearnShowCountryLabels,
  learnShowCapitals, setLearnShowCapitals,
  learnShowRivers, setLearnShowRivers,
  learnShowMountains, setLearnShowMountains
}) => {
        ...
        {isMobile ? (
          ...
          <>
            <div className="hud-top-left">
              ...
              {mode !== 'learn' && (
                <div className="hud-mini-pill score-pill glass-panel" style={{ marginLeft: '8px' }}>
            ...
            <div className="hud-top-right">
              {mode === 'learn' ? (
                <div className="learn-toggles-group glass-panel" style={{ display: 'flex', gap: '4px', padding: '2px', borderRadius: 'var(--radius-full)' }}>
                  <button
                    className={`learn-toggle-btn ${learnShowCountryLabels ? 'active' : ''}`}
                    onClick={() => setLearnShowCountryLabels(!learnShowCountryLabels)}
                    onPointerDown={(e) => e.preventDefault()}
                    title={lang === 'fr' ? 'Afficher les labels des pays' : 'Show country labels'}
                  >
                  ...
                  <button
                    ...
                    onPointerDown={(e) => e.preventDefault()}
                    title={lang === 'fr' ? 'Afficher les capitales' : 'Show capitals'}
                  >
                  ...
                  <button
                    ...
                    onPointerDown={(e) => e.preventDefault()}
                    title={lang === 'fr' ? 'Afficher les rivières' : 'Show rivers'}
                  >
                  ...
                  <button
                    ...
                    onPointerDown={(e) => e.preventDefault()}
                    title={lang === 'fr' ? 'Afficher les montagnes' : 'Show mountains'}
                  >
            ...
            {mobileMenuOpen && mode !== 'learn' && (
              <div className="mobile-dropdown-menu glass-panel animation-fade-in" style={{
                position: 'absolute',
                top: '52px',
                right: '0',
                width: '280px',
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                  ...
                  <div className="progress-linear-container" style={{ height: '6px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px', marginTop: '4px' }}>
                  {gaugeRegions.map(reg => {
                    ...
                    const pct = (regionStats[reg]?.found / regionStats[reg]?.total) * 100 || 0;
                    const displayVal = reg === 'Americas' ? 'AM' : (reg === 'Antarctic' ? 'AN' : reg.substring(0, 2).toUpperCase());
                    return (
                      <div
                        key={reg}
                      ...
                      >
                        <div className="circular-gauge" style={{
                          ...
                          <span className="gauge-val" style={{ zIndex: 1, fontSize: '0.6rem' }}>{displayVal}</span>
                        </div>
          ...
          <>
            ...
            <div className="hud-top-right">
              {mode === 'learn' ? (
                <div className="learn-toggles-group glass-panel" style={{ display: 'flex', gap: '4px', padding: '3px', borderRadius: 'var(--radius-full)' }}>
                  <button
                    className={`learn-toggle-btn ${learnShowCountryLabels ? 'active' : ''}`}
                    onClick={() => setLearnShowCountryLabels(!learnShowCountryLabels)}
                    onPointerDown={(e) => e.preventDefault()}
                    title={lang === 'fr' ? 'Labels pays' : 'Country labels'}
                  >
                    <Globe width={16} height={16} />
                  </button>
                  <button
                    ...
                    onClick={() => setLearnShowCapitals(!learnShowCapitals)}
                    onPointerDown={(e) => e.preventDefault()}
                    title={lang === 'fr' ? 'Capitales' : 'Capitals'}
                  >
                    <MapPin width={16} height={16} />
                  </button>
                  <button
                  ...
                  <button
                    ...
                    onClick={() => setLearnShowMountains(!learnShowMountains)}
                    onPointerDown={(e) => e.preventDefault()}
                    title={lang === 'fr' ? 'Montagnes' : 'Mountains'}
                  >
                    <TreePine width={16} height={16} />
                  </button>
                </div>
