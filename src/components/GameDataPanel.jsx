...
const GameDataPanel = ({
  ...
  const { rowsByRegion, CONTINENT_ORDER } = useMemo(
    () =>
      getPanelData({
        ...
        lang,
        mode,
        revealAll: revealAll || mode === "learn",
        extraEntries,
      }),
    [dataMap, foundList, lang, mode, revealAll, extraEntries],
  );
  ...
  const panelTitle =
    title ||
    (isGameOver ? t("game_over") : mode === "learn" ? t("mode_learn") : t("progress_title"));
